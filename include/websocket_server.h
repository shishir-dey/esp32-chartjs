...
#define WEBSOCKET_SERVER_MAX_CLIENTS 1
#define WEBSOCKET_SERVER_QUEUE_SIZE 50
#define WEBSOCKET_SERVER_QUEUE_TIMEOUT 5
#define WEBSOCKET_SERVER_TASK_STACK_DEPTH 1024
#define WEBSOCKET_SERVER_TASK_PRIORITY 1
#define WEBSOCKET_SERVER_PINNED 1
